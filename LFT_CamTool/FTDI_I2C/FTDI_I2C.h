...
// are compiled with the FTDI_I2C_EXPORTS symbol defined on the command line.
// This symbol should not be defined on any project that uses this DLL.
// This way any other project whose source files include this file see
// FTDI_I2C_API functions as being imported from a DLL, whereas this DLL
// sees symbols defined with this macro as being exported.

#ifdef FTDI_I2C_EXPORTS
#define FTDI_I2C_API __declspec(dllexport)
#else
#define FTDI_I2C_API __declspec(dllimport)
#endif
